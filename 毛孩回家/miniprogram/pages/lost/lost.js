// pages/lost/lost.js - 走丢宠物浏览列表页逻辑
...
Page({
  ...
  async loadData(reset = false) {
    ...
    try {
      const dbQuery = db.collection('lost_pets')
  ...
  onSearch() {
    wx.navigateTo({
      url: '/pages/search/search?type=lost'
    })
  },
  ...
  onCardClick(e) {
    ...
    wx.navigateTo({
      url: `/pages/detail/detail?collection=lost_pets&id=${animal._id}`
    })
  },
